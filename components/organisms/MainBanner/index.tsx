        ...
        <div className="row gap-lg-0 gap-5">
          <div className="col-lg-6 col-12 my-auto">
            ...
            <div className="d-flex flex-lg-row flex-column gap-4">
              <Link href="#feature" role="button">
                <span className="btn btn-get text-lg text-white rounded-pill">
                  Get Started
                </span>
              </Link>
              <Link href="/#" role="button">
                <span className="btn-learn text-lg color-palette-1 my-auto text-center">
                  Learn More
                </span>
              </Link>
            </div>
